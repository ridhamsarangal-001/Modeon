...
export default function NotFound() {
  return (
    <div className="bg-[#F5F3EF] min-h-screen text-black flex flex-col justify-between">
      <div>
        <AnnouncementBar />
        <Header />
      </div>

      <main className="max-w-[1440px] mx-auto px-space-4 md:px-space-5 lg:px-space-6 py-space-10 flex flex-col items-center justify-center text-center select-none">
